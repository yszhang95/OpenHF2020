...
config.JobType.psetName = 'pPb2016SkimAndNtuple_LamCKsP_MC_Training_pT0p9to6_20210212.py'
...
for key, val in dataMap.items():
    config.General.requestName = 'PA8TeV_'+key+'_LamCKsP0p9_pT0p9to6p1_y1p1_MC_Training_20210212'
