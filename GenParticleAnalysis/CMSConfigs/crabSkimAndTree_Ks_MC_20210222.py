...
config.JobType.psetName = 'pPb2016SkimAndNtuple_Ks_MC_20210222.py'
...
for key, val in dataMap.items():
    config.General.requestName = 'PA8TeV_'+key+'_Ks_MC_20210222'
    config.Data.inputDataset = val["PD"]
    config.Data.outputDatasetTag = config.General.requestName
    #config.Data.outLFNDirBase = '/store/group/phys_heavyions/yousen/RiceHIN/OpenHF2020_LamCKsP/MC/'
    config.Data.outLFNDirBase = '/store/user/yousen/RiceHIN/OpenHF2020_Ks/MC/'
