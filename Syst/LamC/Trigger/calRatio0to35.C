void calRatio0to35()
{
  ...
  f.SetParameter(0, 1);
  TFile infile("yields_weighted_Ntrk0to35.root", "READ");
  ...
  auto hframe = c.DrawFrame(0, -0.02, 10, 0.02);
  hframe->SetTitle("MB Ntrk 2--35;p_{T} (GeV);#Lambda_{c}^{+} alternative / default - 1");
