...
cmsDriver.py $cfg  --python_filename ${label}_GENSIM.py --eventcontent RAWSIM --pileup HiMixGEN \
  ...
  --pileup_input "dbs:/ReggeGribovPartonMC_EposLHC_PbP_4080_4080_DataBS/pPb816Spring16GS-MB_80X_mcRun2_pA_v4-v2/GEN-SIM" \
  --nThreads 8 \
  --conditions 80X_mcRun2_pA_v4 --beamspot MatchPPbBoost --step GEN,SIM --scenario HeavyIons --era Run2_2016_pA --no_exec --mc -n $EVENTS || exit $?
